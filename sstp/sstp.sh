...
curl -sS "https://raw.githubusercontent.com/akuhaa021/dboyageproject/main/sstp/accel.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/accel-ppp.conf
